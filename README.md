...
This site is built with [Jekyll](https://jekyllrb.com/), a static site generator, and hosted on GitHub Pages.
...
To add a new chapter, use the provided script:

```bash
./scripts/new_chapter.sh chapter-slug "Chapter Title"
```

For example:
```bash
./scripts/new_chapter.sh 01-introduction "Introduction to LLM Architecture"
```
...
*Note: The original content has been backed up in README.md.bak* 